...
public class JFlatTest {
	...
	void edgeCases() throws IllegalStateException, ParseException, IOException {
		...
		assertThrows(IllegalStateException.class, () -> simple.getFlatTree(), "Non-parsed JSON document should throw an IllegalStateException");

		// empty JSON
		JFlat empty = new JFlat("");
		assertThrows(ParseException.class, () -> empty.parse(), "Empty JSON document should trigger a ParseException error");

		// syntax error
		JFlat wrong = new JFlat("{ this: is a wrong JSON document");
		assertThrows(ParseException.class, () -> wrong.parse(), "JSON document with syntax error should trigger a ParseException error");
